...
![The -75V section of the supply: R491 at 30.1K and R493 at 22.6K form the divider whose midpoint was reading -8V instead of what it should.](image-20230304-114225.png)
...
![The replacement resistors made up from several in series, sleeved in white shrink and fitted across the turret posts.](image-20230304-120153.png)

This fixed the -75V rail (measuring at -75.6V), and the device started working:

![With the rail back at -75.6V the tube lights: a clean green circle from the X-Y inputs.](image-20230304-120401.png)

Sadly enough the pleasure was short lived, because after about one minute I got the Magic Smoke coming from R406:

![R406, arrowed, the 10 ohm in the +250V unregulated feed that started smoking after about a minute.](image-20230304-120512.png)
...
![After matching the deflection amplifiers the circle is round rather than an oval, which means both axes now have the same gain.](image-20230306-201902.png)
